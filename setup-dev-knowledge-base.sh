...
main() {
    ...
    echo "   3. Run: claude 'Following CLAUDE.md, implement the knowledge extraction scripts'"
    echo "   4. Run: python scripts/populate_knowledge_base.py '$OLD_REPO_PATH' ./dev-knowledge-base/docs/pdfs"
    echo "   5. Start developing with: ./dev-cli ask 'your question'"
    echo ""
